...
from Penalyzer.gan.utils import string_utils, augmentation, normalize_line
...
#         for author in json_dict.keys():
#             lines = json_dict[author]
#             self.author_list.add(author)
#             if only_author is not None and type(only_author) is int:
#                 only_author=author
#                 print('Only author: {}'.format(only_author))
#             if only_author is not None and author!=only_author:
#                 continue
...
#             authorLines = len(self.authors[author])
#             print(lines[0])
#             self.authors[author] += [(img_path,)+tuple(l) for l in lines]
...
#                         if img.shape[0] != self.img_height:
#                             print(img.shape, self.img_height)
#                             if img.shape[0] < self.img_height and not self.warning:
#                                 self.warning = True
#                                 print("WARNING: upsampling image to fit size")
#                             percent = float(self.img_height) / img.shape[0]
