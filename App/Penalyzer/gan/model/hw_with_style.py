from Penalyzer.gan.base.base_model import BaseModel
import numpy as np
import torch
...
import math
import cv2
from Penalyzer.gan.model.cnn_lstm import CRNN, SmallCRNN
from Penalyzer.gan.model.cnn_lstm_skip import CRNNSkip
from Penalyzer.gan.model.cnn_only_hwr import CNNOnlyHWR
from Penalyzer.gan.model.google_hwr import GoogleHWR
from Penalyzer.gan.model.style_hwr import AdaINStyleHWR, HyperStyleHWR, DeformStyleHWR
from Penalyzer.gan.model.deform_hwr import DeformHWR
from Penalyzer.gan.model.MUNIT_networks import StyleEncoderHW, HWDecoder, MLP, Deep1DDecoder, Deep1DDecoderWithStyle, Shallow1DDecoderWithStyle, SpacedDecoderWithStyle, NewRNNDecoder, SpacedDecoderWithMask
from Penalyzer.gan.model.MUNIT_networks import get_num_adain_params, assign_adain_params
from Penalyzer.gan.model.pretrained_gen import PretrainedGen
from Penalyzer.gan.model.pure_gen import SpacedGenerator, SpacedUnStyledGenerator, PureGenerator, CharSpacedGenerator, PixelNorm
from Penalyzer.gan.model.style import NewHWStyleEncoder
from Penalyzer.gan.model.vae_style import VAEStyleEncoder
from Penalyzer.gan.model.lookup_style import LookupStyle
from Penalyzer.gan.model.discriminator import Discriminator, DownDiscriminator, TwoScaleDiscriminator, TwoScaleBetterDiscriminator
from Penalyzer.gan.model.cond_discriminator import CondDiscriminator
from Penalyzer.gan.model.cond_discriminator_ap import CondDiscriminatorAP
from Penalyzer.gan.model.test_disc import TestCondDiscriminator, TestImageDiscriminator, TestSmallCondDiscriminator
from Penalyzer.gan.model.char_style import CharStyleEncoder
from Penalyzer.gan.model.char_gen import CharSpacedDecoderWithMask
from Penalyzer.gan.model.char_cond_discriminator_ap import CharCondDiscriminatorAP
from Penalyzer.gan.model.mask_rnn import CountRNN, CreateMaskRNN, TopAndBottomDiscriminator, CountCNN
from Penalyzer.gan.model.char_mask_rnn import CharCountRNN, CharCreateMaskRNN, CharCountCNN
from Penalyzer.gan.model.discriminator import SpectralNorm
from Penalyzer.gan.model.simple_gan import SimpleGen, SimpleDisc
from Penalyzer.gan.model.author_classifier import AuthorClassifier
...
class HWWithStyle(BaseModel):
    ...
    def extract_style(self,image,label,a_batch_size=None):
        ...
        print(batch_size, a_batch_size, image.shape, "*************")
